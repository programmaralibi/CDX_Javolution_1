...
/**
 * The <code>Vector3d</code> class implements a 3-dimensional vector that can
 * represent the position or velocity of an object within a 3D space. This
...
public final class Vector3d {
	...
	/**
	 * The default constructor for the <code>Vector3d</code> returns an object
	...
	/**
	 * The main constructor for the <code>Vector3d</code> class takes the
	 * three coordinates as parameters and produces an object representing that
	 * vector.
	 * 
	 * @param x
