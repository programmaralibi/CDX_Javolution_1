...
/**
 * The <code>VectorConstants</code> class implements some simple utility
...
public final class VectorConstants {
	...
	/**
	 * The <code>west</code> method is a utility function that will set the
	...
	/**
	 * The <code>east</code> method is a utility function that will set the
	...
	/**
	 * The <code>north</code> method is a utility function that will set the
	...
	/**
	 * The <code>south</code> method is a utility function that will set the
	...
	/**
	 * The <code>up</code> method is a utility function that will set the
	 * destination operand to a unit vector pointing in the "up" direction. This
	 * family of functions has been added for convenient access to the common
	...
	/**
	 * The <code>down</code> method is a utility function that will set the
	...
	/**
	 * The <code>direction</code> method is a utility function that will
	 * return a unit vector in the direction specified. It takes an argument in
	 * degrees and a vector destination where it stores the result.
	 * 
	 * @param deg
