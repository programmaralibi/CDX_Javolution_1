 ...
 *  </dl>
 *
 * @see     command.java_cup.runtime.Symbol
 * @see     command.java_cup.runtime.Symbol
 * @see     command.java_cup.runtime.virtual_parse_stack
...
public abstract class lr_parser {
   ...
   * 
   * @see command.java_cup.runtime.lr_parser#get_action
   */
   ...
   *
   * @see command.java_cup.runtime.lr_parser#get_reduce
   */
  ...
  protected static short[][] unpackFromStrings(String[] sa)
	...
	sb.append(sa[i]);
      ...
      int size1 = ((sb.charAt(n))<<16) | (sb.charAt(n+1)); n+=2;
      short[][] result = new short[size1][];
      for (int i=0; i<size1; i++) {
        int size2 = ((sb.charAt(n))<<16) | (sb.charAt(n+1)); n+=2;
