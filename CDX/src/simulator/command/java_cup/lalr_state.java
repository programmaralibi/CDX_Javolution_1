 ...
 *
 * @see     command.java_cup.lalr_item
 * @see     command.java_cup.lalr_item_set
 * @see     command.java_cup.lalr_transition
...
public class lalr_state {
   ...
   * @see   command.java_cup.lalr_item_set#compute_closure
   * @see   command.java_cup.lalr_state#propagate_all_lookaheads
   */
